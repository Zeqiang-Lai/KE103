...
parser.add_argument('--emb_dir', default='embedding/ner', help="Directory containing the embedding")
parser.add_argument('--model_dir', default='experiments/ner', help="Directory containing params.json")
...
if __name__ == '__main__':
    ...
    params.update('embedding/ner/embedding_params.json')
    params.update(os.path.join(args.data_dir, 'dataset_params.json'))
    params.domain_embedding_dim = 0
    ...
    model = net.Net(params, gen_emb, None).cuda() if params.cuda else net.Net(params, gen_emb, None)
